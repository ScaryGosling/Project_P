...
{
    FANATIC, ZOOMER, BOOMER, TIMER, WAND, LIGHTNING, FIREBALL, ICE_NOVA, BOOMER_WARNINGAREA, BLOOD_SPLATTER, HEALTH_PARTICLES, HEALTH_DROP, MANA_POTION, NULL, WAND_IMPACT, FIREBALL_IMPACT
}