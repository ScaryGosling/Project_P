...
{
    FANATIC, ZOOMER, BOOMER, TIMER, WAND, LIGHTNING, FIREBALL, ICE_NOVA, BOOMER_WARNINGAREA, BLOOD_SPLATTER, HEALTH_PARTICLES,
    HEALTH_DROP, MANA_POTION, NULL, WAND_IMPACT, FIREBALL_IMPACT, EXPLOSION, QUEST_COLLECTABLE, OBJECT_SPAWNER, BOOMER_EXPLOSION_PARTICLE, ENEMY_POINTER,
    TACKLE_PARTICLE, BERSERK_PARTICLE, BLINK_PARTICLE, LIGHTNING_IMPACT, LIFE_LEECH
}