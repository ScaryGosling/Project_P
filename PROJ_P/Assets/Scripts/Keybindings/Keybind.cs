...
{
    FORWARD_MOVEMENT, BACKWARD_MOVEMENT, RIGHT_MOVEMENT, LEFT_MOVEMENT, BASE_ATTACK, ABILITY_1, ABILITY_2, ABILITY_3, EXECUTE, REFILL_HEALTH, REFILL_RESOURCE, TOGGLE_SHOP, DIALOGUE
}